!(function (resumeData) {
  ...
  var controller = {
    ...
    hideonclick: function () {
      ...
      view.firstIntro.addEventListener('touchstart', function (evt) {
        eraseme(this);
      });
    },
    deviceTilted: function (evt) {
      view.shine.setAttribute(
        'style',
        'transform:rotate(' +
          ((Math.atan2(evt.gamma, evt.beta) * 180) / Math.PI + 30) +
          'deg)'
      );
    },
  ...
  var view = {
    ...
    render: function () {
      this.displayElement.innerHTML = Mustache.to_html(this.template, {
        ...data,
        ...mustacheMethods,
      });
    },
